    ...
    const projects = [
        {
            ...
            emoji: "🛒",
            description: "AI-powered tool to help users find products and suggest recipes based on available ingredients.",
        ...
        },
        {
            title: "AvatarGen",
            emoji: "🎨",
            description: "Custom ComfyUI node that transforms user photos into stylized character avatars.",
        ...
        },
        {
            ...
            emoji: "📚",
            description: "Simple assistant interface that helps summarize papers from arXiv and chat with them.",
        ...
        <main className="relative min-h-screen max-w-3xl mx-auto px-4 py-12 md:px-8 md:py-24">
            <div className="space-y-6">
                ...
                <div className="grid gap-8">
                    <p className="text-muted-foreground italic">Here are some of my ongoing open-source projects, crafted as I dive deep into AI and GenAI, blending learning with hands-on innovation.</p>
